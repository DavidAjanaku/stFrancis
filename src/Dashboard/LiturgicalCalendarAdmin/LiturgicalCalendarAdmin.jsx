...
const LiturgicalCalendarAdmin = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const response = await fetch('https://distinct-stranger-production.up.railway.app/api/liturgical-calendar');
  ...
  const handleSubmit = async () => {
    try {
      ...
      const endpoint = editingEvent 
        ? `'https://distinct-stranger-production.up.railway.app/api/liturgical-calendar/${editingEvent._id}`
        : 'https://distinct-stranger-production.up.railway.app/api/liturgical-calendar';
  ...
  const handleDelete = async (eventId) => {
    ...
    try {
      ...
      const response = await fetch(`'https://distinct-stranger-production.up.railway.app/api/liturgical-calendar/${eventId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
