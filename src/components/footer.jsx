        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-200">Oregun, Lagos</p>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 bg-green-800 rounded-full flex items-center justify-center hover:bg-green-700 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/mass-sacraments" className="text-green-200 hover:text-white transition-colors">Mass Times</Link></li>
              <li><Link to="/societies" className="text-green-200 hover:text-white transition-colors">Societies</Link></li>
              <li><Link to="/events" className="text-green-200 hover:text-white transition-colors">Events</Link></li>
              <li><Link to="/homilies" className="text-green-200 hover:text-white transition-colors">Homilies</Link></li>
              <li><Link to="/gallery" className="text-green-200 hover:text-white transition-colors">Gallery</Link></li>
              <li><Link to="/bulletins" className="text-green-200 hover:text-white transition-colors">Bulletins</Link></li>
              <li><Link to="/prayer-requests" className="text-green-200 hover:text-white transition-colors">Prayer Requests</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-green-200">+234 xxx xxx xxxx</span>
              </div>
              <div className="flex items-center space-x-2">
                <MessageCircle size={16} className="text-green-300" />
                <span className="text-green-200">WhatsApp Available</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail size={16} className="text-green-300" />
                <span className="text-green-200">info@stfrancisoregun.org</span>
              </div>
            </div>
